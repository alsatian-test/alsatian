...
export function padNumber(originalNumber: number, minimumIntegerLength: number) {
    ...
    const numberString = zeroCache.slice(0, minimumIntegerLength - integerLength) + absoluteNumber.toString();

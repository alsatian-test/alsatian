...
export class FunctionSpyMatcherTests {
  ...
  public nullOrUndefinedSpyThrowsError(spy: FunctionSpy) {
    Expect(() => new FunctionSpyMatcher(spy)).toThrowError(
      TypeError,
      "spy must not be null or undefined."
    );
  }
  ...
  public negativeOrZeroExactlyValueThrowsError(expectedCallCount: number) {
    ...
    Expect(() => spyMatcher.exactly(expectedCallCount).times).toThrowError(
      TypeError,
      "expectedCallCount must be greater than 0."
    );
  }
  ...
  @TestCase(2, 1)
  @TestCase(42, 2)
  public exactlyDoesntMatchThrowsError(
  ...
  public negativeOrZeroAnythingButValueThrowsError(expectedCallCount: number) {
    ...
    Expect(() => spyMatcher.anythingBut(expectedCallCount).times).toThrowError(
      TypeError,
      "unexpectedCallCount must be greater than 0."
    );
  }
  ...
  @TestCase(2, 1)
  @TestCase(42, 2)
  public anythingButMatchesDoesNotThrow(
  ...
  public negativeOrZeroLessThanValueThrowsError(expectedCallCount: number) {
    ...
    Expect(() => spyMatcher.lessThan(expectedCallCount).times).toThrowError(
      TypeError,
      "maximumCallCount must be greater than 0."
    );
  }
  ...
  @TestCase(2, 1)
  @TestCase(42, 36)
  public lessThanMatchesDoesNotThrow(
  ...
  @TestCase(2, 3)
  @TestCase(42, 56)
  public lessThanDoesntMatchThrowsError(
    maximumCallCount: number,
    actualCallCount: number
  ) {
    const some = {
    ...
    if (maximumCallCount === 1) {
      Expect(() => spyMatcher.lessThan(maximumCallCount).times).toThrowError(
        FunctionCallCountMatchError,
  ...
  public negativeOrZeroGreaterThanValueThrowsError(expectedCallCount: number) {
    ...
    Expect(() => spyMatcher.greaterThan(expectedCallCount).times).toThrowError(
      TypeError,
      "minimumCallCount must be greater than 0."
    );
  }
  ...
  @TestCase(2, 3)
  @TestCase(42, 56)
  public greaterThanMatchesDoesNotThrow(
    maximumCallCount: number,
    actualCallCount: number
  ) {
    const some = {
  ...
  @TestCase(2, 1)
  @TestCase(42, 36)
  public greaterThanDoesntMatchThrowsError(
    maximumCallCount: number,
    actualCallCount: number
  ) {
    const some = {
    ...
    if (maximumCallCount === 1) {
      Expect(() => spyMatcher.greaterThan(maximumCallCount).times).toThrowError(
        FunctionCallCountMatchError,

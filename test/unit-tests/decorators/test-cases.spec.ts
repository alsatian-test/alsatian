...
export class TestCaseDecoratorTests {
  ...
  public noTestsAddedOnNull() {
    ...
    const testCases: Array<any> = Reflect.getMetadata(METADATA_KEYS.TEST_CASES, testFixture, "key");
  ...
  public testCaseArgumentsFromArrayMetaDataAdded(expectedArguments: Array<Array<any>>) {
  ...
  @TestCase([ [1], [2], [3] ])
  @TestCase([ ["this"], ["that"], ["the other"] ])
  public testCaseArgumentsFromArrayDelegateMetaDataAdded(expectedArguments: Array<Array<any>>) {
    const testCaseDecorator = TestCasesDecorator(() => expectedArguments);
  ...
  @TestCase([ [1], [2], [3] ])
  @TestCase([ ["this"], ["that"], ["the other"] ])
  public testCaseArgumentsFromGeneratorMetaDataAdded(expectedArguments: Array<Array<any>>) {
    ...
    const testCaseDecorator = TestCasesDecorator(generator(expectedArguments));
  ...
  @TestCase([ [1], [2], [3] ])
  @TestCase([ ["this"], ["that"], ["the other"] ])
  public testCaseArgumentsFromGeneratorDelegateMetaDataAdded(expectedArguments: Array<Array<any>>) {

...
export class PropertySetMatchErrorTests {
  ...
  public shouldBeSetToValueMessage(value: any) {
    ...
    Expect(error.message).toBe(
      `Expected property to be set to ${JSON.stringify(value)}.`
    );
  }
  ...
  public shouldNotBeSetToValueMessage(value: any) {
    ...
    Expect(error.message).toBe(
      `Expected property not to be set to ${JSON.stringify(value)}.`
    );
  }
  ...
  public expectedValueAndShouldMatchShouldBeSetToPropertyToBeSetToValue(
    ...
    Expect(error.expected).toBe(
      "property to be set to " + JSON.stringify(value) + "."
    );
  }
  ...
  public expectedValueAndShouldNotMatchShouldBeSetToPropertyNotToBeSetToValue(
    ...
    Expect(error.expected).toBe(
      "property not to be set to " + JSON.stringify(value) + "."
    );
  }
}

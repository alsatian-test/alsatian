...
export class FunctionCallCountMatchErrorTests {
  ...
  public shouldBeCalledMessage(callCount: number) {
    ...
    if (callCount === 1) {
      ...
      Expect(error.message).toBe(
        "Expected function to be called " + callCount + " times."
      );
    }
  }
  ...
  public shouldBeCalledGreaterThanMessage(callCount: number) {
    ...
    if (callCount === 1) {
      ...
      Expect(error.message).toBe(
        "Expected function to be called greater than " + callCount + " times."
      );
    }
  }
  ...
  public shouldBeCalledLessThanMessage(callCount: number) {
    ...
    if (callCount === 1) {
      ...
      Expect(error.message).toBe(
        "Expected function to be called less than " + callCount + " times."
      );
    }
  }
  ...
  @TestCase(2)
  @TestCase(42)
  public expectedValueAndShouldMatchGreaterThanShouldBeSetToFunctionToBeCalled(
    callCount: number
  ) {
    const fakeFunction: FunctionSpy = new FunctionSpyBuilder().build();
  ...
  @TestCase(2)
  @TestCase(42)
  public expectedValueAndShouldMatchLessThanShouldBeSetToFunctionToBeCalled(
    callCount: number
  ) {
    const fakeFunction: FunctionSpy = new FunctionSpyBuilder().build();
  ...
  public anyArgumentOutputAsAnythingInMessage() {
    ...
    const functionCallError = new FunctionCallCountMatchError(
      fakeSpy,
      true,
      1,
      SpyCallCountType.Exactly,
    ...
    Expect(functionCallError.message).toBe(
      "Expected function to be called with [Anything] 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function to be called with [Anything, Anything] 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInNotExpectedMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function not to be called with [Anything] 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInNotExpectedMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function not to be called with [Anything, Anything] 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInGreaterThanMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function to be called with [Anything] greater than 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInGreaterThanMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function to be called with [Anything, Anything] greater than 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInLessThanMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function to be called with [Anything] less than 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInLessThanMessage() {
    ...
    Expect(functionCallError.message).toBe(
      "Expected function to be called with [Anything, Anything] less than 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function to be called with [Anything] 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function to be called with [Anything, Anything] 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInNotExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function not to be called with [Anything] 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInNotExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function not to be called with [Anything, Anything] 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInGreaterThanExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function to be called with [Anything] greater than 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInGreaterThanExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function to be called with [Anything, Anything] greater than 1 time."
    );
  }
  ...
  public anyArgumentOutputAsAnythingInLessThanExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function to be called with [Anything] less than 1 time."
    );
  }
  ...
  public twoAnyArgumentsBothOutputAsAnythingInLessThanExpectedValue() {
    ...
    Expect(functionCallError.expected).toBe(
      "function to be called with [Anything, Anything] less than 1 time."
    );
  }
  ...
  @TestCase(Object)
  @TestCase(Array)
  public anyTypeArgumentOutputAsAnyTypeInGreaterThanMessage(
    type: new (...args: Array<any>) => object
  ) {
    const fakeSpy: FunctionSpy = new FunctionSpyBuilder().build();
  ...
  @TestCase(Object)
  @TestCase(Array)
  public anyTypeArgumentOutputAsAnyTypeInLessThanMessage(
    type: new (...args: Array<any>) => object
  ) {
    const fakeSpy: FunctionSpy = new FunctionSpyBuilder().build();
  ...
  public twoAnyTypeArgumentsBothOutputAsAnyTypeInExpectedValue(
    ...
    Expect(functionCallError.expected).toBe(
      `function to be called with [Any ${(typeOne as INameable).name}, Any ${
        (typeTwo as INameable).name
      }] 1 time.`
    );
  }
  ...
  public anyTypeArgumentOutputAsAnyTypeInNotExpectedValue(
    ...
    Expect(functionCallError.expected).toBe(
      `function not to be called with [Any ${(type as INameable).name}] 1 time.`
    );
  }
  ...
  public twoAnyTypeArgumentsBothOutputAsAnyTypeInNotExpectedValue(
    ...
    Expect(functionCallError.expected).toBe(
      `function not to be called with [Any ${
        (typeOne as INameable).name
      }, Any ${(typeTwo as INameable).name}] 1 time.`
    );
  }
  ...
  public exactAndAnyTypeArgumentsBothOutputAsExactAndAnyTypeInExpectedValue(
    ...
    Expect(functionCallError.expected).toBe(
      `function to be called with [${JSON.stringify(exactValue)}, Any ${
        (type as INameable).name
      }] 1 time.`
    );
  }
  ...
  public exactAndAnyTypeArgumentsBothOutputAsExactAndAnyTypeInNotExpectedValue(
    ...
    Expect(functionCallError.expected).toBe(
      `function not to be called with [${JSON.stringify(exactValue)}, Any ${
        (type as INameable).name
      }] 1 time.`
    );
  }
  ...
  public anyTypeAndExactArgumentsBothOutputAsAnyTypeAndExactInMessage(
    ...
    Expect(functionCallError.message).toBe(
      `Expected function to be called ` +
        `with [Any ${(type as INameable).name}, ${JSON.stringify(
          exactValue
        )}] 1 time.`
    );
  }
  ...
  public anyTypeAndExactArgumentsBothOutputAsAnyTypeAndExactInExpectedValue(
    ...
    Expect(functionCallError.expected).toBe(
      `function to be called with [Any ${
        (type as INameable).name
      }, ${JSON.stringify(exactValue)}] 1 time.`
    );
  }

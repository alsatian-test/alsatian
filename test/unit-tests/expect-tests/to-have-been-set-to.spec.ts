...
export class ToHaveBeenSetToTests {
  ...
  public propertyNotSetFailsWithCorrectError() {
    ...
    Expect(() => Expect(propertySpy).toHaveBeenSetTo("something")).toThrowError(
  ...
  public propertyNotSetPassesWhenShouldNotCall() {
    ...
    Expect(() =>
      Expect(propertySpy).not.toHaveBeenSetTo("something")
    ).not.toThrow();
  }
  ...
  public propertySetWhenShouldNotBeSetThrowsCorrectError(expectedValue: any) {
    ...
    Expect(() =>
      ...
      PropertySetMatchError,
      `Expected property not to be set to ${JSON.stringify(expectedValue)}.`
    );
  }
  ...
  @TestCase("42", 42)
  @TestCase(42, "42")
  public propertySetToSimilarValuePassesWhenShouldNotBeSet(
    expectedValue: any,
    similarValue: any
  ) {
    const some = {
  ...
  @TestCase("42", 42)
  @TestCase(42, "42")
  public propertySetToSimilarValueFailsWhenShouldBeSet(
    expectedValue: any,
    similarValue: any
  ) {
    const some = {
  ...
  public actualValueAndShouldMatchShouldBeSetToPropertyWasNotSetToValue(
    values: Array<any>
  ) {
    const some = {
      set property(value: any) {}
  ...
  @TestCase(["something", "and", "another", "thing"])
  @TestCase(["this", "or", "this", "or", "that", "other", "thing"])
  public actualValueAndShouldNotMatchShouldBeSetToPropertyWasSetToValue(
    values: Array<any>
  ) {
    const some = {
      set property(value: any) {}
  ...
  @TestCase(() => {})
  @TestCase((thisCouldBe: any) => "function")
  public expectedValueAndShouldMatchShouldBeSetToPropertyToBeSetToValue(
    expectedValue: any
  ) {
    const some = {
      set property(value: any) {}
    ...
    Expect(propertyError.expected).toBe(
      "property to be set to " + JSON.stringify(expectedValue) + "."
    );
  }
  ...
  @TestCase(() => {})
  @TestCase((thisCouldBe: any) => "function")
  public expectedValueAndShouldNotMatchShouldBeSetToPropertyNotToBeSetToValue(
    expectedValue: any
  ) {
    const some = {
      set property(value: any) {}
    ...
    Expect(propertyError).not.toBeNull();
    Expect(propertyError.expected).toBe(
      "property not to be set to " + JSON.stringify(expectedValue) + "."
    );
  }
}

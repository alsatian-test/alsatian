...
export class ToHaveBeenCalledWithTests {
  ...
  @TestCase([1, "argument"])
  @TestCase(["argument", 1])
  public functionCalledWithCorrectArgumentsPasses(
  ...
  public functionThrowsErrorFailsWithCorrectError() {
    ...
    Expect(() => Expect(some.function).not.toHaveBeenCalledWith()).toThrowError(
      FunctionCallMatchError,
  ...
  @TestCase(["1", "42"], [1, 42])
  @TestCase([1, 42], ["1", "42"])
  public functionCalledWithSimilarArgumentsPasses(
    expectedArguments: Array<any>,
    actualArguments: Array<any>
  ) {
    const some = {
  ...
  @TestCase([], [1, 42])
  @TestCase([42, 1], [])
  public functionCalledWithWrongNumberOfArgumentsPasses(
    expectedArguments: Array<any>,
    actualArguments: Array<any>
  ) {
    const some = {
  ...
  @TestCase([1, "argument"])
  @TestCase(["argument", 1])
  public functionNotCalledWithDifferentArgumentsFailsWithCorrectError(
    expectedArguments: Array<any>
  ) {
    const some = {
      function: () => {}
  ...
  public checkingWhetherNonFunctionSpyOrSpiedOnFunctionHasBeenCalledShouldThrow(
    ...
    Expect(() => EXPECT.toHaveBeenCalledWith()).toThrowError(
      TypeError,
  ...
  public checkingWhetherNonFunctionSpyOrSpiedOnFunctionHasNotBeenCalledShouldThrow(
    ...
    Expect(() => EXPECT.not.toHaveBeenCalledWith()).toThrowError(
      TypeError,
      "toHaveBeenCalledWith requires value passed in to Expect to be a FunctionSpy or a spied on function."
    );
  }
  ...
  public anyArgumentShouldNotThrowIfThreeArguments() {
    ...
    Expect(() =>
      Expect(some.function).toHaveBeenCalledWith(Any, Any, Any)
    ).not.toThrow();
  }
  ...
  public anyArgumentShouldThrowIfOneArgumentExpectedAndNotProvided(
    ...callArguments: Array<any>
  ) {
    const some = {
      function: (...args: Array<any>) => {}
    };
    ...
    Expect(() => Expect(some.function).toHaveBeenCalledWith(Any)).toThrowError(
      FunctionCallMatchError,
  ...
  @TestCase("some", "function", "arguments")
  public anyArgumentShouldThrowIfTwoArgumentsExpectedAndNotProvided(
    ...callArguments: Array<any>
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(1, 2, 3)
  @TestCase("some", "function", "arguments")
  public anyArgumentShouldThrowWithExpectedMessageIfOneArgumentExpectedAndNotProvided(
    ...callArguments: Array<any>
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(1, 2, undefined)
  @TestCase("some", "function", "arguments")
  public anyArgumentShouldThrowWithexpectedMessageIfTwoArgumentsExpectedAndNotProvided(
    ...callArguments: Array<any>
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Number(42))
  @TestCase(new Number(-42))
  public anyNumberArgumentShouldNotBeCalledShouldThrowIfNumberArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Error())
  @TestCase(new Error("something went wrong"))
  public anyNumberArgumentShouldThrowWithExpectedValueIfNonNumberArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase("test")
  @TestCase(new String("test"))
  public anyStringArgumentShouldNotBeCalledShouldThrowIfStringArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Error())
  @TestCase(new Error("something went wrong"))
  public anyStringArgumentShouldThrowWithExpectedValueIfNonStringArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Boolean(true))
  @TestCase(new Boolean(false))
  public anyBooleanArgumentShouldNotBeCalledShouldThrowIfBooleanArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Error())
  @TestCase(new Error("something went wrong"))
  public anyBooleanArgumentShouldThrowWithExpectedValueIfNonBooleanArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Error())
  @TestCase(new Error("something went wrong"))
  public anyObjectArgumentShouldNotBeCalledShouldThrowIfObjectArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(true)
  @TestCase(false)
  public anyObjectArgumentShouldThrowWithExpectedValueIfNonObjectArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Array([]))
  @TestCase(new Array(["an", "array"]))
  public anyArrayArgumentShouldNotBeCalledShouldThrowIfArrayArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Error())
  @TestCase(new Error("something went wrong"))
  public anyArrayArgumentShouldThrowWithExpectedValueIfNonArrayArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Error())
  @TestCase(new Error("something went wrong"))
  public anyErrorArgumentShouldNotBeCalledShouldThrowIfErrorArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Array([]))
  @TestCase(new Array(["an", "array"]))
  public anyErrorArgumentShouldThrowWithExpectedValueIfNonErrorArgument(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(new Array([]))
  @TestCase(new Array(["an", "array"]))
  public expectedExactArgumentAndAnyArgumentGivenCorrectArgumentsPass(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
    ...
    Expect(() =>
      Expect(some.function).toHaveBeenCalledWith(42, Any)
    ).not.toThrow();
  }
  ...
  @TestCase(new Array(["an", "array"]))
  @TestCase(new Array(["an", "array"]))
  public expectedAnyArgumentAndExactArgumentGivenCorrectArgumentsPass(
    argument: any
  ) {
    const some = {
      function: (...args: Array<any>) => {}
    ...
    Expect(() =>
      Expect(some.function).toHaveBeenCalledWith(Any, 42)
    ).not.toThrow();
  }
  ...
  @TestCase(2)
  @TestCase(42)
  public calledExactlyCorrectNumberOfTimesWithCorrectArgumentsPasses(
  ...
  @TestCase(2)
  @TestCase(42)
  public calledExactlyCorrectNumberOfTimesWithCorrectAnyArgumentsPasses(
    expectedCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(2)
  @TestCase(42)
  public calledExactlyCorrectNumberOfTimesWithCorrectAnyTypeArgumentsPasses(
    expectedCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
    ...
    Expect(
      () =>
        Expect(some.function)
          .toHaveBeenCalledWith(Any(Number))
          .exactly(expectedCallCount).times
    ).not.toThrow();
  }
  ...
  @TestCase(3)
  @TestCase(42)
  public calledExactlyCorrectNumberOfTimesWithWrongArgumentsThrowsError(
    expectedCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(3)
  @TestCase(42)
  public calledExactlyCorrectNumberOfTimesWithRightArgumentsInTheWrongOrderThrowsError(
    expectedCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(3)
  @TestCase(42)
  public calledAnythingButCorrectNumberOfTimesWithExtraCallWithWrongArgumentsThrowsError(
    expectedCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(2)
  @TestCase(42)
  public calledGreaterThanCorrectNumberOfTimesWithOneCallWithWrongArgumentsThrowsError(
    minimumCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(4)
  @TestCase(42)
  public calledLessThanCorrectNumberOfTimesWithOneCallWithWrongArgumentsPasses(
    maximumCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(4)
  @TestCase(42)
  public calledLessThanCorrectNumberOfTimesWithExtraCallWithArgumentsInWrongOrderPasses(
    maximumCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(2)
  @TestCase(42)
  public calledTheSameTimesWhenExpectedLessThanThrowsError(
    maximumCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}
  ...
  @TestCase(2)
  @TestCase(42)
  public calledOneMoreTimesWhenExpectedLessThanThrowsError(
    maximumCallCount: number
  ) {
    const some = {
      function: (...args: Array<any>) => {}

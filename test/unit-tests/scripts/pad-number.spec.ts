...
export class PadNumberTests {
    ...
    public singleDigitPaddedCorrectly(numberOfZeros: number, expectedOutput: string) {
    ...
    public doubleDigitPaddedCorrectly(numberOfZeros: number, expectedOutput: string) {
    ...
    public negativePaddedCorrectly(numberOfZeros: number, expectedOutput: string) {
        Expect(padNumber(-42, numberOfZeros)).toBe(expectedOutput);
    }
    ...
    public singleDecimalPaddedCorrectly(numberOfZeros: number, expectedOutput: string) {
